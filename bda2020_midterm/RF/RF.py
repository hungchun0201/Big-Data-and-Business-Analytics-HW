...
def train(trainX, trainY):
    ...
    train_X, valid_X, train_Y, valid_Y = train_test_split(trainX, trainY, test_size=0.2, random_state=0)
    ...
    pca = PCA(n_components=600, random_state=100)
